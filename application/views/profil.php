...
<div id="general">
	...
	<div id="espace">
			...
			<tr>
				<table width="450px" style="border-top : 1px solid #CCC;">
					<tr>
						...
						<td align="center"><a href=<?php echo '"/Afak/index.php/profil/session/statut/'.$id_agent.'/'.$id_session.'"';?> title="Publier une photo" target="_self">Statut</a></td>
						<td  width="30px" align="center"><img src="/Afak/application/images/photo_icon.png" width="25" height="25" alt="testing" /></td>
						<td align="center"><a href=<?php echo '"/Afak/index.php/profil/session/photo/'.$id_agent.'/'.$id_session.'"';?> title="Publier une photo" target="_self">Photo</a></td>
						<td  width="30px" align="center"><img src="/Afak/application/images/video_icon.png" width="25" height="25" alt="testing" /></td>
						<td align="center"><a href=<?php echo '"/Afak/index.php/profil/session/video/'.$id_agent.'/'.$id_session.'"';?> title="Publier une video" target="_self">Video</a></td>
						<td  width="30px" align="center"><img src="/Afak/application/images/exercice-icon.png" width="25" height="25" alt="testing" /></td>
						<td align="center"><a href=<?php echo '"/Afak/index.php/profil/session/exercice/'.$id_agent.'/'.$id_session.'"';?> title="Publier un Exercice" target="_self">Exercice</a></td>
						<td  width="30px" align="center"><img src="/Afak/application/images/article_icon.png" width="25" height="25" alt="testing" /></td>
						<td width="40px" align="center"><a href=<?php echo '"/Afak/index.php/profil/session/article/'.$id_agent.'/'.$id_session.'"';?> title="Publier un article" target="_self">Article</a></td>
					</tr>
				</table>
			</tr>
		</table>
		...
		<div id="actu">
			...
			<?php if ($this->amis->is_amis($node["id_agent"],$id_agent)):?>
				<table width="450px">
					<tr>
						...
						<?php endif;?>		
								...
								<tr><td style="background-color : #EEEEFF; padding:4px;">
									<form method="post" action="/Afak/index.php/profil/publish_com">
